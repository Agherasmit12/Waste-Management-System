        ...
        <div class="wrapper">
            ...
            <div id="maintable">
                ...
                <form action="waste.php" method="get">
                    From : <input type="text" name="d1" class="tcal" value="" autocomplete="off" /> To: <input
                        type="text" name="d2" class="tcal" value="" autocomplete="off" />
                    <input type="submit" name="submit" value="Search"><a id="addd"
                        href="javascript:Clickheretoprint()">Print</a>
                </form>
